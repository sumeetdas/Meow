...
function processAndCacheBlogPostFile (fileName) {
    ...
    return fs
        ...
        .then(function (data) {
            ...
            var metaData     = utils.getMetaData (data), publisedDate;
            ...
            if (metaData['published-date']) {
                ...
                tempData = tempData
                    .slice(0,1)
                    .concat('published-date: ' + publisedDate)
            ...
            var posts = cache.get('posts') || {}, postKey = publisedDate + '-' + utils.generateSlug(metaData.title);
